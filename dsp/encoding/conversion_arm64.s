...
#define UI8_TO_C64_BLOCK_SIZE 32

	MOVW	$0x80, R3
	WORD	$0x4e010c60 // dup v0.16b, w3

    CMP     $UI8_TO_C64_BLOCK_SIZE, R1
    BLT     u8toc64_scalar

u8toc64_simd_loop:
    WORD    $0xad400801 // ldp q1, q2, [x0]
    ADD     $UI8_TO_C64_BLOCK_SIZE, R0
    ...
    ADD     $(UI8_TO_C64_BLOCK_SIZE*4), R2
    SUB     $UI8_TO_C64_BLOCK_SIZE, R1
	WORD    $0xad3f2047 // stp q7, q8, [x2,-32]
    CMP     $UI8_TO_C64_BLOCK_SIZE, R1
    BGE     u8toc64_simd_loop
